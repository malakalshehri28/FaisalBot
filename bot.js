...
client.user.setActivity('BadStation.', { type: 'WATCHING' })
});
...
client.on('guildMemberAdd', member=> {
    member.addRole(member.guild.roles.find("name","Bd."));
    });
...
client.on('message', message => {
  ...
  if (message.content.startsWith(prefix + "user")) {
   ...
   if(!message.channel.guild) return message.reply(`**This is just for servers**`);
...
if(message.content.startsWith("اسحب")) {
 ...
 return message.channel.send("**اسحب [mentions]**")
}
